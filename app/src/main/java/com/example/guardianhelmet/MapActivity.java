...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
                ...
                if (loc == null) {
                    ...
                    try {
                        ...
                        if (addressList.size() > 0) {
                            ...
                            gMap.animateCamera(CameraUpdateFactory.newLatLngZoom(latLng, 15)); // Adjusted zoom level
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        googleMap.animateCamera(CameraUpdateFactory.newLatLngZoom(latLng, 15)); // Adjusted zoom level
